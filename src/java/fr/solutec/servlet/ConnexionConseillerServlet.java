 ...
 * @author 33624
 */
@WebServlet(name = "ConnexionConseillerServlet", urlPatterns = {"/connexionConseiller"})
public class ConnexionConseillerServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
 request.getRequestDispatcher("WEB-INF/connexionConseiller.jsp").forward(request, response);    }
